resource "oci_identity_policy" "function_policy" {
  ...
  statements = [
    ...
    "Allow dynamic-group ${oci_identity_dynamic_group.function_dynamic_group.name} to use autonomous-vmclusters in tenancy",
    "Allow dynamic-group ${oci_identity_dynamic_group.function_dynamic_group.name} to use cloud-autonomous-vmclusters in tenancy",
    "Allow dynamic-group ${oci_identity_dynamic_group.function_dynamic_group.name} to use cloud-vmclusters in tenancy",
    "Allow dynamic-group ${oci_identity_dynamic_group.function_dynamic_group.name} to use integration-instance in tenancy",
    "Allow dynamic-group ${oci_identity_dynamic_group.function_dynamic_group.name} to use vmclusters in tenancy",
